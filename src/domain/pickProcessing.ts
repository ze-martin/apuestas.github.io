...
import { createSuggestedParlay as createSuggestedParlayBase } from './recommendationRules.mjs'
export { isHighAccuracyRecommendation, recommendationProfileLabel, recommendationProfileScore } from './recommendationRules.mjs'
...
export function createSuggestedParlay(picks: ProcessedPick[], maxLegs = 3) {
  return createSuggestedParlayBase(picks, maxLegs)
}
